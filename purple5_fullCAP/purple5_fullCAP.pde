...
void draw() {
  ...
  pizza.text(alphabetUp, pizza.width-width+100, pizza.height-(height+100),width-200,height-50); //slight offset from center on the Y to make it feel more centered vertically
  pizza.endDraw();
